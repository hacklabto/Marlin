...
#define HOMING_FEEDRATE {50*60, 50*60, 0, 0}  // set the homing speeds (mm/min)

// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402/0.838,    78.7402/0.838,    200.0/3/0.4*10/1.3,    760*1.1/16}  // Measured, corrected for microstepping.
